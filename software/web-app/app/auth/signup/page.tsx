...
export default function SignUp() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-black via-purple-950/20 to-black p-4">
      ...
      <div className="relative z-10 w-full max-w-md">
        <div className="relative">
          ...
          <div className="relative bg-black/60 backdrop-blur-md rounded-2xl p-8 border border-purple-500/20">
            ...
            <p className="text-gray-400 text-center mb-6">Join BitRocket and start your journey</p>

            {error && (
              <div className="mb-4 p-3 bg-red-900/20 border border-red-500/30 rounded-lg flex items-center gap-2 text-red-200">
            ...
            <div className="space-y-3">
              <Button
                ...
                disabled={isLoading}
                className="w-full border-purple-500/30 hover:border-purple-500/50 bg-black/50"
              >
